...
# ./build.sh
# ./build.sh --tag <BUILD_TAG> --target <BUILD_TARGET> --config <CONFIG_FILE_PATH> --push
...
##   + config <CONFIG_FILE_PATH>: filepath for the build arguments, default is <root>/etc/
...
#################
build(){
  local image_prefix_name="ghcr.io/uab-cgds-worthey/charmomics/"
  local service_name=$1
