...
class AnnotationService:
    ...
    @staticmethod
    def process_tasks(
        annotation_queue: AnnotationQueue, annotation_manifest_collection: AnnotationManifestCollection,
                    ...
                    if annotation_unit.has_dependencies():
                        ...
                        for missing_dataset_name in missing_dependencies:
                            ...
                            dependency_annotation_unit = AnnotationUnit(
                                annotation_unit.genomic_unit, annotation_manifest_dataset
                            )
                            dependency_annotation_unit.set_latest_version(annotation_manifest_dataset['version'])
                ...
                for future in concurrent.futures.as_completed(annotation_task_futures):
                    ...
                    try:
                        ...
                        if isinstance(task, VersionAnnotationTask):
                            ...
                            annotation_manifest_collection.add_dataset_to_manifest(annotation_unit)
                            annotation_queue.put(annotation_unit)
                        else:
